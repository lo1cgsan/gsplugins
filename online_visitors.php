...
add_action('plugins-sidebar','createSideMenu',array($thisfile,'Użytkownicy online'));
...
?>
<label>Użytkownicy online &#8211; ustawienia</label> <br/>
<p style="padding-left:10px">Podaj czas, w którym będą zliczane i pokazywane wizyty na stronie.<br>
Domyślna wartość <b>10</b> powoduje że, plugin zliczał będzie odwiedzających z ostatnich 10 minut.<br>
Możesz również zmienić etykietę licznika.
</p>
<form method="post" action="<?php echo $_SERVER ['REQUEST_URI']?>">
<table class="highlight" id="OnlineVisitorsTable">
    <tr>
        <td>Czas</td>
        <td><input type="text" name="time" value="<?php echo $setting_value['time'];?>" /> <small>(w minutach)</small></td>
    </tr>
    <tr>
        <td>Etykieta</td>
...
$displayviscounter = '<div id="usersonline">'.$settings_value['label'].': <span>' . $totalvisitors. '</span></div>';// HTML code with data to be displayed
